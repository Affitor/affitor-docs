---
title: Glossary
description: Common terms used across Affitor docs — server-side tracking, Stripe integration, invoice billing, and more
---
...
### Platform Fee
Affitor's fee on partner-generated revenue: $0 until a program's affiliate-driven revenue reaches $10,000, then 3.5% of each affiliate-driven sale. The threshold is counted per program.
