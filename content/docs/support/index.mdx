...
<Checklist
  items={[
    { text: 'Read the FAQ for common pricing, tracking, and payout questions', href: '/faq' },
    ...
    { text: 'Check the system status page if you think something may be degraded', href: '/support/status' },
  ]}
/>
