...
:::tip
The CLI is the fastest way to set up Affitor. If you prefer a UI, use the [dashboard quickstart](/docs/advertisers/quickstart/create-account) instead.
:::
...
.affitor/
  ...
  AGENTS.md       -- AI agent instructions (universal format)
```
