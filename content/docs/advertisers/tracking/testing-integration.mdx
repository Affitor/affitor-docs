...
description: Verify click, signup, and sale tracking before going live
---
...
:::tip[CLI test commands]
The Affitor CLI can send test events for each layer in one command:
...
See [CLI Commands](/docs/advertisers/cli/commands/) for details.
:::
