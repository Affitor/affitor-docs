...
Run `npx affitor init` to create your program and receive your program ID, API key, and ready-to-use tracking snippets. See the [CLI Quickstart](/advertisers/cli/quickstart/).
:::
