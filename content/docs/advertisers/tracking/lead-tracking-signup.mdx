...
This creates a test lead event against your program and confirms the endpoint is working. See [CLI Commands](/docs/advertisers/cli/commands/) for all available test commands.
