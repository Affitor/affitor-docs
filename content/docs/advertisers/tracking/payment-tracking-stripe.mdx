...
Run `npx affitor setup stripe` to automatically configure Stripe webhooks via OAuth — no manual URL copy-paste or event selection needed. See the [CLI Quickstart](/docs/advertisers/cli/quickstart/) for the full setup flow.
:::
...
- [Payment Flow](/docs/advertisers/tracking/payment-flow/)
