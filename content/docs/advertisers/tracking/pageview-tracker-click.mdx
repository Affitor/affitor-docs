...
:::tip
Run `npx affitor init` to get a ready-to-use tracker snippet with your program ID pre-filled. See the [CLI Quickstart](/docs/advertisers/cli/quickstart/).
:::
...
- [Lead Tracking](/docs/advertisers/tracking/lead-tracking-signup/)
