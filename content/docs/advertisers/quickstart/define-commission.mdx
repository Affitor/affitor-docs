...
You can also set commission details when creating your program via the CLI:

```bash
npx affitor init
# prompts for commission type (percent/fixed) and rate
```
...
- **[Commission Approval & Cash Flow](/docs/advertisers/quickstart/commission-approval-cash-flow)** – How commissions are validated and paid
- **[Payouts](/docs/advertisers/quickstart/payouts)** – Partner payout schedules and methods