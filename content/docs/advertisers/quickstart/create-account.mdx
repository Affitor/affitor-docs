...
> [!NOTE]
> You don't need a Stripe account yet — we'll set that up in a later step. Focus on creating your account first.
...
> [!WARNING]
> Make sure you select "I'm a Company" (Advertiser) and not "I'm a Partner" (Affiliate). Companies are businesses looking to work with affiliates, while Partners are marketers looking to promote products.

### Step 4: Login with Company Email
...
> [!TIP]
> Use an email like `partnerships@yourcompany.com` or `affiliates@yourcompany.com` rather than a personal email. This makes it easier to manage team access later.
...
### Step 6: Complete Initial Setup Wizard
...
> [!TIP]
> This wizard only appears for new accounts. Once completed, you'll have full access to your advertiser dashboard and can manage all settings from there.
