---
title: "Pricing"
description: "Affitor pricing: $0/month, $0 setup, 3.5% of partner-generated revenue — and each program's first $10,000 in affiliate-driven revenue is fee-free."
---
...
Affitor is not the merchant of record for your sales: customer payments never pass through Affitor. Your weekly invoice (approved partner commissions plus the platform fee) is paid to Affitor LLC, and Affitor pays partners from it when they withdraw.

:::

## Cash flow and payout workflow

Commissions wait out your program's hold period, then are approved and added to the partner's balance; partners request withdrawals, which Affitor sends. Timing varies by program settings — treat your dashboard as the authoritative operational reference.

[→ See full cash flow details](/brand/quickstart/commission-approval-cash-flow)

## $10K guarantee

Each program's first $10,000 in affiliate-driven revenue is fee-free. The threshold is counted per program, so every program you run gets its own $10,000. Refunds do not lower the revenue counted toward it.
