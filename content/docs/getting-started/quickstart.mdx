...
<Flow>
  <FlowStep caption="You define commissions, the hold period, and payout settings.">Launch a program</FlowStep>
  ...
  <FlowStep caption="Hold, approve, and pay out — all in one place.">Payout</FlowStep>
</Flow>
