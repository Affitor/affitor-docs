...
| Header | Value |
|--------|-------|
| `Deprecation` | Unix timestamp of when the key was marked for rotation ([RFC 9745](https://www.rfc-editor.org/rfc/rfc9745)) |
...
| `Link` | `<https://docs.affitor.com/docs/api-reference/errors#api_key_rotation_required>; rel="deprecation"` |
  ...
  "warnings": [
    {
      ...
      "docs_url": "https://docs.affitor.com/docs/api-reference/errors#api_key_rotation_required"
    }
  ]
}
```
