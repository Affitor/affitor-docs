...
**3. Sale tracking** — three options in priority order: Stripe OAuth auto-connect, Sale API, Stripe metadata:
...
```javascript
// Option C: Stripe metadata (manual Checkout Sessions)
metadata: {
...
- [SDK Reference](/api-reference/sdks/) — `@affitor/tracker` package for React and Next.js
