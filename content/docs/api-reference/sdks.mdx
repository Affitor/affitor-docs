...
> **Beta** — The @affitor/sdk / @affitor/sdk/server SDKs and CLI are in active development. The documented happy-path works; edge cases may change. Report issues on GitHub.
