...
When attribution succeeds, Affitor records the sale and creates the commission flow. Commissions then wait out the program's hold period, are approved into the partner's balance, and are paid out when the partner requests a withdrawal.
...
Affitor is not the merchant of record for your sales: customer payments stay in your Stripe account. Your weekly invoice (approved partner commissions plus the platform fee) is paid to Affitor LLC, and Affitor pays partners when they withdraw.
...
| 7+ | commission enters the hold period, then is approved into the partner balance |
