...
<VerifySuccess
  dashboard={["Groups shows your group with the new rate in the Commission column", "Run a test-mode sale (`additional_data: { test_mode: true }`) — the commission appears under Commissions → Pending, computed at the group's rate"]}
