...
![Applications waiting for review — approve or decline each with an optional reason](/docs/brand/applications.png)
...
The dashboard does not have a self-serve action to remove a partner from your program yet. If a partner violates your terms, [contact support](/support/contact) with the partner and program details.
