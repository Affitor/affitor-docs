...
1. [Install Tracking](/docs/advertisers/tracking/quickstart-integration)
...
If your team prefers terminal-based setup, the [Affitor CLI](/docs/advertisers/cli/quickstart/) is an alternative path for developer and agent-driven workflows.
