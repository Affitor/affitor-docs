...
### When do I pay?
Platform fees accrue per attributed sale and are billed through **weekly invoices**, issued every Monday at 09:00 UTC and due 7 days after issue by default. You can download each invoice as a PDF and pay it with Stripe Checkout from your Billing tab. If an invoice goes unpaid, your program can be paused — see the [overdue policy](/brand/billing/overdue-policy).
