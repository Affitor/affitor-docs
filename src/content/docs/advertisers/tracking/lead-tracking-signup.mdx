...
```
[Affitor Tracker] ✅ Affitor: customerKey detected - user_123
...
**Without `customerKey`:**
```
[Affitor Tracker] ❌ Affitor: customerKey is REQUIRED for signup() - payment attribution will not work without it!
[Affitor Tracker]    Please include customerKey in your signup call:
[Affitor Tracker]    await window.affitor.signup('user_123', 'user@example.com')
[Affitor Tracker] trackTest() called true
```
