...
|-------------|---------|------------|
| [Pageview Tracker](/tracking/pageview-tracker) | Track clicks from affiliate links | Easy – one script tag |
| [Lead Tracking](/tracking/lead-tracking) | Track signups and registrations | Easy – one function call |
| [Payment Tracking](/tracking/payment-tracking-stripe) | Track sales via Stripe | Medium – metadata setup |
...
1. **[Pageview Tracker](/tracking/pageview-tracker)** – Capture clicks (5 minutes)
2. **[Lead Tracking](/tracking/lead-tracking)** – Capture signups (10 minutes)
3. **[Payment Tracking](/tracking/payment-tracking-stripe)** – Capture sales (15 minutes)
4. **[Test Your Integration](/tracking/testing-integration)** – Verify everything works