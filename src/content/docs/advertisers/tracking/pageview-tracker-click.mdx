...
[Affitor Tracker] 📝 Writing test cookies: {affitor_click_id: "test_customer_...", affiliate_url: "..."}
[Affitor Tracker] Cookie set: {name: "affitor_click_id", value: "test_customer_...", expires: ...}
[Affitor Tracker] Cookie set: {name: "affiliate_url", value: "...", expires: ...}
[Affitor Tracker] 📖 Reading test cookies back: {affitor_click_id: "test_customer_...", affiliate_url: "..."}
[Affitor Tracker] ✅ Cookie verification PASSED - All cookies working correctly!
[Affitor Tracker] trackTest() called true
[Affitor Tracker] Sending test event to verify tracking: {clickId: null, hasAttribution: false, eventType: "test"}
```
...
[Affitor Tracker]    affitor_click_id cookie issue:
