...
- Looks up customer-partner relationship using `user_id`
- Extracts partner, customer, and program information
...
**[Test Your Integration →](/advertisers/tracking/testing)**
